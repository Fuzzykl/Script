...
if World1 then
        if game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position.Y > 4500 then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
        elseif game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position.X > 50000 then
    ...
    elseif World2 then
        if game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position.Z > 30000 then
...
function CheckQuestLevel()
    ...
    if World1 then
		...
		elseif Level == 150 or Level <= 174 then
			...
			if  _G.AutoFarmLevel and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 1000 then
		        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
            end
		...
		elseif Level == 375 or Level <= 399 then
			...
			if  _G.AutoFarmLevel and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
        ...
        elseif Level == 475 or Level <= 524 then
		    ...
		    if  _G.AutoFarmLevel and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
        ...
        elseif Level == 525 or Level <= 549 then
		    ...
		    if  _G.AutoFarmLevel and (CFrameMon.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 2000 then
		        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.61767578125, 5547.1416015625, -380.29119873046875))
            end
...
function CheckLevelBoss(SelectBoss)
    ...
    elseif SelectBoss == "Fishman Lord" then
        ...
        if  _G.AutoFarmBoss and (CFrameBoss.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 10000 then
	        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
        end
    elseif SelectBoss == "Wysper" then
        ...
        if  _G.AutoFarmBoss and (CFrameBoss.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
		    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.61767578125, 5547.1416015625, -380.29119873046875))
        end
    elseif SelectBoss == "Thunder God" then
        ...
        if  _G.AutoFarmBoss and (CFrameBoss.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 2000 then
	        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.61767578125, 5547.1416015625, -380.29119873046875))
        end
...
Tele = Library:Tab("Dịch Chuyển",11446920523)
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoSea2 or _G.TeleTween or _G.AutoObservePoint or _G.AutoFarmNear or _G.AutoFarmBoss or _G.AutoBringFruit or _G.Clip or _G.AutoFarmLevel or _G.AutoChest or _G.FarmPlayer then
...
spawn(function()
    while task.wait() do
        ...
        elseif _G.AutoFarmNear then
            pcall(function()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1000 and not string.find(v.Humanoid.DisplayName, "Boss") and v.Humanoid.Health > 0 then
                        repeat game:GetService("RunService").Heartbeat:wait()
                            EquipWeapon(SelectWeapon)
                            AutoHaki()
                            v.HumanoidRootPart.CanCollide = false
    ...
    pcall(function()
        while task.wait() do
            if _G.AutoFarmBoss then
                ...
                if CFrameBoss then
                    local GetBoss = game:GetService("Workspace").Enemies:FindFirstChild(SelectBosss)
                    if GetBoss then
                        if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        ...
                        until not _G.AutoFarmBoss or GetBoss.Humanoid.Health <= 0
                        FastAttack = false
                    else
                        FastAttack = false
                        TP(CFrameBoss)
...
function Chest100()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
	    if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 100 then
			    _G.Chest100 = v
			    return
			end
		end
...
function Chest500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 500 then
			    _G.Chest500 = v
			    return
			end
		end
...
function Chest1000()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1000 then
			    _G.Chest1000 = v
			    return
			end
		end
...
function Chest1500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 1500 then
			    _G.Chest1500 = v
			    return
			end
		end
...
function Chest2000()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2000 then
			    _G.Chest2000 = v
			    return
			end
		end
...
function Chest2500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2500 then
			    _G.Chest2500 = v
			    return
			end
		end
...
function Chest3500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3500 then
			    _G.Chest3500 = v
			    return
			end
		end
...
function Chest4500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 4500 then
			    _G.Chest4500 = v
			    return
			end
		end
...
function Chest5500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 5500 then
			    _G.Chest5500 = v
			    return
			end
		end
...
function Chest6500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 6500 then
			    _G.Chest6500 = v
			    return
			end
		end
...
function Chest7500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 7500 then
			    _G.Chest7500 = v
			    return
			end
		end
...
function Chest9500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 9500 then
			    _G.Chest9500 = v
			    return
			end
		end
...
function Chest10500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10500 then
			    _G.Chest10500 = v
			    return
			end
		end
...
function Chest12500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 12500 then
			    _G.Chest12500 = v
			    return
			end
		end
...
function Chest15500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 15500 then
			    _G.Chest15500 = v
			    return
			end
		end
...
function Chest17500()
	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
		if v.Name == "Chest1" or v.Name == "Chest2" or v.Name == "Chest3" then
		    if (v.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 17500 then
			    _G.Chest17500 = v
			    return
			end
		end
...
if World3 then
    ...
    local CheckingBone = Main:Label("Xương : 0")
    spawn(function()
        pcall(function()
            while wait() do
...
Main:Seperator("Haki Quan Sát")

local ObservePoint = Main:Label("Điểm Quan Sát : ???")
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
		if game:GetService("Players").LocalPlayer.VisionRadius.Value == 3000 then
			...
			value = math.round(game:GetService("Players").LocalPlayer.VisionRadius.value)
		end
		ObservePoint:Set("Điểm Quan Sát : "..tostring(value))
	end
end)

Main:Toggle("Farm Điểm Quan Sát",false,function(value)
    _G.AutoObservePoint = value
    StopTween(value)
end)
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoObservePoint then
                local GetMon = game:GetService("Workspace").Enemies:FindFirstChild("Bandit")
                if GetMon and game:GetService("Players").LocalPlayer.VisionRadius.Value ~= 3000 and (Vector3.new(1199.31287, 52.2717781, 1536.91516) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 300 then
                    if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                        repeat
                            game:GetService("RunService").Heartbeat:wait()
                            TP(GetMon.HumanoidRootPart.CFrame)
                        until not _G.AutoObservePoint or GetMon.Humanoid.Health < 0 or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                        TP(GetMon.HumanoidRootPart.CFrame * CFrame.new(0,30,0))
                    ...
                    TPD(CFrame.new(1199.31287, 52.2717781, 1536.91516))
                    TP(CFrame.new(1199.31287, 52.2717781, 1536.91516))
                end
            end
        end
    end)
...
Main:Seperator("Nhiệm Vụ Thế Giới")
if World1 then
    Main:Toggle("Tự Động Sea 2",false,function(value)
        _G.AutoSea2 = value
        StopTween(value)
    end)
            ...
            while wait() do
                if _G.AutoSea2 then
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress","Detective") == 1 then
                        ...
                        if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Key") and game:GetService("Workspace").Map.Ice:FindFirstChild("Door") then
                            FastAttack = false
                            repeat
                                wait()
                                EquipWeapon("Key")
                                TP(CFrame.new(1348.312744140625, 37.349327087402344, -1326.2479248046875))
                            until not _G.AutoSea2 or (Vector3.new(1348.312744140625, 37.349327087402344, -1326.2479248046875) - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 1 or not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Key")
                        end
                        if not game:GetService("Workspace").Map.Ice:FindFirstChild("Door") then
                            ...
                            repeat 
                                ...
                                FastAttack = true
                            until BossIce.Humanoid.Health <= 0 or not _G.AutoSea2
                            FastAttack = false
                        end
                    end
                end
	    	...
	    	if _G.AutoBringFruit then
		    	for i,v in pairs(game:GetService("Workspace"):GetChildren()) do
			    	if string.find(v.Name, "Fruit") then
				        ...
				        repeat task.wait()
					        TP(v.Handle.CFrame)
				    	until game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position == v.Handle.CFrame.Position or not _G.AutoBringFruit or not v.Name
				    end
			    end
		    end
        end
...
if World2 then
    Raid:Toggle("Định Vị Hoa",FlowerESP,function(value)
        FlowerESP = value
...
if World3 then
	Raid:Toggle("Định Vị Trái Cây Thật",RealFruitESP,function(a)
		RealFruitESP = a
...
Raid:Toggle("Định Vị Người Chơi",ESPPlayer,function(value)
    ESPPlayer = value
...
Raid:Toggle("Định Vị Rương",ChestESP,function(value)
    ChestESP = value
...
Raid:Toggle("Định Vị Trái Blox",DevilFruitESP,function(value)
    DevilFruitESP = value
...
Misc:Seperator("Tùy Chọn Phe")

Misc:Button("Đổi Phe Hải Tặc",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    wait(3)
end)

Misc:Button("Đổi Phe Hải Quân",function()
                ...
                if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter") == "I don't have anything for you right now. Come back later." then
                    ...
                    for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, v.Name) then
                            TPD(v.HumanoidRootPart.CFrame)
                            repeat
                                task.wait()
                                AutoHaki()
                                if (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 20 then
                                    FastAttack = true
                                end
                               TP(v.HumanoidRootPart.CFrame)
                            until not _G.FarmPlayer or v.Humanoid.Health <= 0 or game:GetService("Players").LocalPlayer.PlayerGui.Main.PvpDisabled.Visible or game:GetService("Players"):FindFirstChild(v.Name).Data.Level.Value <= 20
                            FastAttack = false
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                        end
                    end
        ...
        while wait() do
            if _G.FarmPlayer then
                for x,y in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                    for i,v in pairs(game:GetService("Workspace").Characters:GetChildren()) do
                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, v.Name) and (v.HumanoidRootPart.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 10 then
                            game:GetService("RunService").Heartbeat:wait()
                            if y.ToolTip == "Melee" then
                                EquipWeapon(y.Name)
                            ...
                            elseif y.ToolTip == "Blox Fruit" then
                                EquipWeapon(y.Name)
                                for a,b in pairs(SkillList) do
                                    game:GetService("VirtualInputManager"):SendKeyEvent(true,b,false,game)
                                    game:GetService("VirtualInputManager"):SendKeyEvent(false,b,false,game)
...
Tele:Toggle("Đi Tới Đảo [Tween]",false,function(value)
    _G.TeleTween = value
    if _G.TeleTween then
    repeat wait()
