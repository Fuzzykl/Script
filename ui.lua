if game.CoreGui:FindFirstChild("HuyHub") then
    game.CoreGui:FindFirstChild("HuyHub"):Destroy()
end

local HuyHub = Instance.new("ScreenGui")
local HuyHubX = Instance.new("TextButton")
local HuyHubUI = Instance.new("UICorner")
...
HuyHub.Name = "HuyHub"
        ...
        HuyHubX.Name = "HuyHubX"
        HuyHubX.Parent = HuyHub
        HuyHubX.BackgroundColor3 = Color3.fromRGB(30,20,20)
        HuyHubX.BorderSizePixel = 0
        HuyHubX.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
        HuyHubX.Size = UDim2.new(0, 50, 0, 50)
        HuyHubX.Font = Enum.Font.SourceSans
        HuyHubX.Text = "X"
        HuyHubX.TextColor3 = Color3.fromRGB(255, 255, 255)
        HuyHubX.TextSize = 14.000
        HuyHubX.Draggable = true
        HuyHubX.MouseButton1Click:Connect(function()
        game.CoreGui:FindFirstChild("HuyXHub").Enabled = not game.CoreGui:FindFirstChild("HuyXHub").Enabled
        end)
        do
        if game:GetService("CoreGui"):FindFirstChild("HuyXHub") then
        end
        end

        HuyHubUI.Name = "HuyHubUI"
        HuyHubUI.Parent = HuyHubX

        MODILEMAGE.Name = "MODILEMAGE"
        MODILEMAGE.Parent = HuyHubX
...
do local GUI = game.CoreGui:FindFirstChild("HuyXHub");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
function Update:Window(text,logo,keybind)
	...
	local HuyXHub = Instance.new("ScreenGui")
	HuyXHub.Name = "HuyXHub"
	HuyXHub.Parent = game.CoreGui
	HuyXHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	...
	Main:TweenSize(UDim2.new(0, 650, 0, 350),"Out","Quad",0.4,true)
